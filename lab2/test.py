...
# reguly
rule1 = ctrl.Rule(distance['close'] & relative_speed['high'] & friction['low'], braking_force['strong'])
rule2 = ctrl.Rule(distance['close'] & relative_speed['medium'] & friction['medium'], braking_force['moderate'])
rule3 = ctrl.Rule(distance['medium'] & relative_speed['medium'] & friction['high'], braking_force['light'])
...
if __name__ == "__main__":
   #TODO: Zaimplementować interfejs użytkownika do wprowadzania wartości
   #TODO: Zaimplementować symulację działania systemu w pygame
   sys.exit(0)
